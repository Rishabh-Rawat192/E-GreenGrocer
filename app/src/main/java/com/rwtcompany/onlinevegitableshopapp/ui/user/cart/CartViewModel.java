...
public class CartViewModel extends ViewModel {
    ...
    void placeOrder(String requestTime){
        ...
        OrderDetails orderDetails = new OrderDetails(userDetails.getValue().getAddress(),userDetails.getValue().getName(),userDetails.getValue().getNumber(), orderExtraCharges.getValue().getDeliveryCharge(), orderId, "pending...", requestTime, String.valueOf(this.totalCost));
