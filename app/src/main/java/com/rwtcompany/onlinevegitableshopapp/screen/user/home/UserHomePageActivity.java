...
import com.rwtcompany.onlinevegitableshopapp.screen.user.cart.CartActivity;
    ...
    private void setUpRecyclerView(){
        ...
        FirebaseRecyclerOptions<AdminItems> options =
                new FirebaseRecyclerOptions.Builder<AdminItems>()
                        ...
                        .build();
        adapter = new FirebaseRecyclerAdapter<AdminItems,HomePageViewHolder>(options)
        {
...
//                      GETTING INTEGER PART FROM RATE OF ITEM
    ...
    private void updateUIAfterAddOrRemove(int quantity, int position, HomePageViewHolder holder, AdminItems model) {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.userLogout) {
            ...
            startActivity(new Intent(UserHomePageActivity.this, UserOrders.class));
        }
