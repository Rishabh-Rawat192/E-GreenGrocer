...
public class CartActivity extends AppCompatActivity implements CustomAdapter.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel.userDetails.observe(this,userDetails -> Log.i("DATA",userDetails.toString()));
    ...
    public void order(View view) {
        ...
        if (viewModel.totalCost < minOrderPrice) {
            ...
            if (!viewModel.userDetails.getValue().getDeliveryDetails().getAddress().isEmpty()) {
                ...
                tvRetrieveAddress.append(viewModel.userDetails.getValue().getDeliveryDetails().getAddress());
                tvRetrievePhone.append("Phone:");
                tvRetrievePhone.append(viewModel.userDetails.getValue().getDeliveryDetails().getNumber());
                tvRetrieveName.append("Name:");
                tvRetrieveName.append(viewModel.userDetails.getValue().getDeliveryDetails().getName());
    ...
    void addAddress() {
        ...
        btnConfirmAddress.setOnClickListener(v -> {
            ...
            if (address.isEmpty() || number.isEmpty() || requestTime.isEmpty() || name.isEmpty())
                ...
                //update userDetails
                viewModel.userDetails.getValue().setDeliveryDetails(new DeliveryDetails(address,name,number));
